...
namespace SchedulingApi.Infrastructure
{
    public class ConsulHostedService : Microsoft.Extensions.Hosting.IHostedService
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _logger.LogInformation($"Registering in Consul. Status:{_consulClient.Status.ToString()}");
