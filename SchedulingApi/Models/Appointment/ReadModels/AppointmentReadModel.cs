...
namespace AppointmentApi
{
    ...
    public class AppointmentReadModel : IMongoDbReadModel,
        IAmReadModelFor<AppointmentAggregate, AppointmentId, LocationSetEvent>,
...

    {
        ...
        public void Apply(IReadModelContext context, IDomainEvent<AppointmentAggregate, AppointmentId, LocationSetEvent> domainEvent)
        {
            Location = domainEvent.AggregateEvent.Location;
        }
