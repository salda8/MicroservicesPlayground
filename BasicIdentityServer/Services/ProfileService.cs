    ...
    public class ProfileService : IProfileService
    {
        ...
        async public Task IsActiveAsync(IsActiveContext context)
        {
            ...
            if (user != null)
            {
                ...
                context.IsActive =
                    ...
                    user.LockoutEndDate.Instant <= DateTime.Now;
            }
        }
        ...
        private IEnumerable<Claim> GetClaimsFromUser(ApplicationUser user)
        {
            ...
            if (_userManager.SupportsUserEmail)
            {
                claims.AddRange(new[]
                {
                    new Claim(JwtClaimTypes.Email, user.Email.NormalizedValue),
                    //new Claim(JwtClaimTypes.EmailVerified, user. ? "true" : "false", ClaimValueTypes.Boolean)
                });
            }
